    ...
    <form action="event_update.php" method="POST">
        <fieldset>
            ...
            <div>
                ...
                <input type="text" name="event_name" value="<?= $record["event_name"] ?>" placeholder="体験名を記入してください" size="100" maxlength="24">
            </div>
            ...
            <div>
                ...
                <div>
                    ...
                    <input type="text" name="event_detail" value="<?= $record["event_detail"] ?>" size="100" maxlength="200">
                </div>
            </div>

            <!-- <div>
                <h1>カテゴリー*</h1>
                <select name="event_category" value="<?= $record["event_category"] ?>">
            ...
            <!-- <select id="select-pref" name="pref" value="<?= $record["pref"] ?>">
                    <option value="">都道府県を選択してください</option>
                </select><br>
                <select id="select-city" name="city" value="<?= $record["city"] ?>">
            ...
            <div>
                <h1>参加定員*</h1>
                <input type="number" name="how_many" value="<?= $record["how_many"] ?>" min="1" max="100">人<br>
            </div>

            <div>
                <h1>体験にかかる時間*</h1>
                集合から解散までの時間を設定してください。(0.5時間単位)<br>
                <input type="number" name="how_long" value="<?= $record["how_long"] ?>" step="0.5" min="0.5" max="100">時間<br>
            </div>
            ...
            <div>
                ...
                <input type="number" name="how_much_adult" value="<?= $record["how_much_adult"] ?>" step="100" min="0">円<br>
                <!-- 子供料金設定<br>
            ...
            <div>
                ...
                <input type="number" name="min_person" value="<?= $record["min_person"] ?>" min="1">人<br>
            </div>
            <div>
